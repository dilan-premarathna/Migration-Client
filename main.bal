...
public function main() returns error? {
    ...
    string[][] headers = [["API Name", "Scopes", "SOAP API", "EndpointSecurity", "Grants", "CustomMediation", "Authorization Header", "Access Control", "Additional Properties", "Response Caching", "Visibility Feature", "Custom Throttling Policy", "Endpoint Type","Max Tps", "Migration Supported"]];
